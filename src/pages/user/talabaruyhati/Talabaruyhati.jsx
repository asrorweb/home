        ...
        <div className="min-h-screen mt-[100px] max-md:mt-[80px]">
            <div className="container py-9 mx-auto ">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div class="flex p-2 items-center justify-between pb-4 bg-white dark:bg-gray-900">
                        <div>
                            <button
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                >
                                    <img
                                        ...
                                        alt="Jese image"
                                        src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8dXNlcnxlbnwwfHwwfHw%3D&w=1000&q=80"
                                    />
                                    <div class="pl-3">
